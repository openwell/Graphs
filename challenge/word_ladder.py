...
# so the logic is it then to loop through an the queue gets big
# until he finds the combination that has the end word at the end of the 
# dequeue array

if __name__ == '__main__':
    print(find_word_ladder("hit", "cot"))
    # ['hit', 'cit', 'cot']
